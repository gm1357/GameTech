...
class GameDetail {
  ...
  factory GameDetail.fromJson(Map<String, dynamic> json) {
    return GameDetail(
      developers: json['developers'] != null ? json['developers'].map((obj) => obj['name']).toList().cast<String>() : [],
      franchises: json['franchises'] != null ? json['franchises'].map((obj) => obj['name']).toList().cast<String>() : [],
      genres: json['genres'] != null ? json['genres'].map((obj) => obj['name']).toList().cast<String>() : [],
